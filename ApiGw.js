...
function ApiGw( apis, layersModulePath ) {
	if( layersModulePath ) appModulePath.addPath( layersModulePath );
	const lambdas = {};
	...
	if( layersModulePath ) appModulePath.removePath( layersModulePath );
